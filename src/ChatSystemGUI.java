...
/**
 * A ChatSystem GUI to test with no transport layer.
 * 
 * @author C. TOMBELLE
 */
public class ChatSystemGUI extends javax.swing.JFrame implements IProcess {
...
//		setExtendedState(MAXIMIZED_BOTH);
	...
	public static void main(String args[]) {
		...
		gui.setVisible(true);
		new ChatClientGUI(gui._chatServer, "client1").setVisible(true);
		new ChatClientGUI(gui._chatServer, "client2").setVisible(true);
		new ChatClientGUI(gui._chatServer, "client3").setVisible(true);
	}
}
